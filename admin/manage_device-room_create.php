<?php include "source/php/manage_device-room.php" ?>
<?php include "../resource/env/header.php" ?>

<body class="bg-dark">
    <div class="container d-flex justify-content-center align-items-center p-5">
        <form class="bg-light border shadow p-5 rounded" action="source/php/manage_device-room.php" method="post" enctype="multipart/form-data">
            <div class="my-4">
