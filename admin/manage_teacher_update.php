<?php include "source/php/update_manage_teacher.php" ?>
<?php include "../resource/env/header.php" ?>

<body class="bg-dark">
    <div class="container d-flex justify-content-center align-items-center p-5">
        <form class="bg-light border shadow p-5 rounded" action="source/php/update_manage_teacher.php" method="post" enctype="multipart/form-data">
            <div class="my-4">
            ...
            <div class="row">
                <div class="col-12">
                    <div class=" form-group mb-4">
                        ...
                        <input type="text" class="form-control" id="t_name" name="t_name" value="<?= $row['t_name'] ?>">
                    </div>
                </div>
            </div>
